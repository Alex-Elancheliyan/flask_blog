...
from firstproject.models import User, Post
from firstproject.forms import RegisterUser, LoginForm, UpdateAccountForm, PostForm
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(post)
        db.session.commit()
        flash('Your post hass been created!',"success")
        return redirect(url_for('home'))
    return render_template('create_post.html',tittle ='New Post',form=form, legend='New Post')
...
def update(post_id):
    ...
    return render_template('create_post.html',tittle ='Update Post',form=form, legend="Update Post")
